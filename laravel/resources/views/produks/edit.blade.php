    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
            <div class="p-8">
                ...
                <form action="{{ route('produks.update', $produk) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="number" name="stok" value="{{ old('stok', $produk->stok) }}" placeholder="0"
                        ...
                        <div>
                            ...
                            <input type="number" name="harga" value="{{ old('harga', $produk->harga) }}" step="0.01" placeholder="0" required
                        ...
                        <div>
                            ...
                            <input type="number" name="harga_beli" value="{{ old('harga_beli', $produk->harga_beli) }}" step="0.01" placeholder="0"
                        ...
                        <div>
                            ...
                            <input type="number" name="diskon" value="{{ old('diskon', $produk->diskon ?? 0) }}" step="0.01" min="0" max="100" placeholder="0"
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <textarea name="deskripsi" rows="5" placeholder="Masukkan deskripsi produk..."
                                      class="w-full px-4 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent @error('deskripsi') border-red-500 @enderror">{{ old('deskripsi', $produk->deskripsi) }}</textarea>
                            @error('deskripsi')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
