                            ...
                            <div class="mt-2 text-sm text-yellow-700">
                                <ul class="list-disc pl-5 space-y-1">
                                    @foreach($produkStokRendah as $produk)
                                        <li>
                                            <strong>{{ $produk->nama }}</strong> - Stok: <span class="font-bold text-red-600">{{ $produk->stok }}</span>
                                            <a href="{{ route('produks.edit', $produk) }}" class="ml-2 text-blue-600 hover:text-blue-800 underline">Edit</a>
                                        </li>
                                    @endforeach
                                </ul>
                            </div>
